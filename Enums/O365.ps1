Add-Type -TypeDefinition @"
    ...
    namespace PSWinDocumentation
    {
        ...
        public enum O365 {
            ...
            O365ExchangeMailboxesStatistics,
            O365ExchangeMailboxesStatisticsArchive,
            O365ExchangeMailboxesPermissions,
            O365ExchangeMailboxesPermissionsIncludingInherited,
            ...
            O365UExchangeMailboxesPermissions,
